...
fn remap_monster_id(monster_id: i32) -> i32 {
    let mappings: &[(i32, i32)] = &[
        // Assassin's Creed
        (27804, 27314), (27814, 27314),
        (27901, 27411), (27911, 27411),
        (27902, 27412), (27912, 27412),
        (27903, 27413), (27913, 27413),
        (27904, 27414), (27914, 27414),
        (27905, 27415), (27915, 27415),
        (28001, 27511), (28011, 27511),
        (28002, 27512), (28012, 27512),
        (28003, 27513), (28013, 27513),
        (28004, 27514), (28014, 27514),
        (28005, 27515), (28015, 27515),
        (28101, 27611), (28111, 27611),
        (28102, 27612), (28112, 27612),
        (28103, 27613), (28113, 27613),
        (28104, 27614), (28114, 27614),
        (28105, 27615), (28115, 27615),
        (28201, 27711), (28211, 27711),
        (28202, 27712), (28212, 27712),
        (28203, 27713), (28213, 27713),
        (28204, 27714), (28214, 27714),
        (28205, 27715), (28215, 27715),

        // The Witcher 3 - Geralt
        (29601, 29211), (29611, 29211),
        (29602, 29212), (29612, 29212),
        (29603, 29213), (29613, 29213),
        (29604, 29214), (29614, 29214),
        (29605, 29215), (29615, 29215),

        // Yennefer
        (29801, 29411), (29811, 29411),
        (29802, 29412), (29812, 29412),
        (29803, 29413), (29813, 29413),
        (29804, 29414), (29814, 29414),
        (29805, 29415), (29815, 29415),

        // Triss
        (29901, 29511), (29911, 29511),
        (29902, 29512), (29912, 29512),
        (29903, 29513), (29913, 29513),
        (29904, 29514), (29914, 29514),
        (29905, 29515), (29915, 29515),

        // Ciri
        (29701, 29311), (29711, 29311),
        (29702, 29312), (29712, 29312),
        (29703, 29313), (29713, 29313),
        (29704, 29314), (29714, 29314),
        (29705, 29315), (29715, 29315),
    ];
