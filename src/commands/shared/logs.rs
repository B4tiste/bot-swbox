...
use crate::{Data, MONGO_URI, commands::shared::models::LoggerDocument};
...
pub async fn send_log(
    ...
    collection.insert_one(log).await.map_err(|e| Error::Other(Box::leak(Box::new(e.to_string()))))?;
    Ok(())
}

pub async fn get_server_name(ctx: &poise::ApplicationContext<'_, Data, Error>) -> Result<String, Error> {
